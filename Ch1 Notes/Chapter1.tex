...
Interval notation is central to many of the problems at the heart of calculus. Just to name one, consider the compound inequality we solved earlier: $7 < 11 - 4x \leq 18$. Our solution to this inequality took the form $-\frac{7}{4} \leq x < 1$. In interval notation, we can write this more succinctly as $[-\frac{7}{4},1)$.


\section{Lines and Graphs}


\section{Elementary and Inverse Functions}
